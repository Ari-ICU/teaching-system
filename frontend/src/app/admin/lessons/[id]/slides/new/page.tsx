...
export default function NewSlidePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const parsedContent = useMemo(() => {
    if (!formData.content) return "<p style='opacity:0.25;font-style:italic'>Start writing to see the preview...</p>";
  ...
  return (
    <div className="page" style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <header className="page-header" style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
             ...
             <span className="badge badge-indigo">SLIDE STUDIO</span>
          </div>
          <h1 className="page-title" style={{ fontSize: '28px' }}>Crafting: {lesson?.title}</h1>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: activeTab === "edit" ? "1fr" : "1fr", gap: '32px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
              ...
              <div className="grid-2">
                <div>
                  ...
                  <input 
                    ...
                    style={{ width: '100%', padding: '14px', fontSize: '18px', fontWeight: 600 }}
                ...
                <div>
                  ...
                  <DropdownSelect 
                    options={[
                      ...
                      { value: "practice", label: "Practice (Code)" },
                  ...
                  <div style={{ 
                    ...
                    {imagePreview ? (
                      ...
                      <div style={{ color: 'var(--text-muted)' }}>
                        <p style={{ fontSize: '14px', marginBottom: '8px' }}>Drag & drop or click to upload</p>
                        <p style={{ fontSize: '12px' }}>Best for diagrams or technical illustrations</p>
                      </div>
                    )}
                    <input 
                      type="file" 
              ...
              <div>
                ...
                <textarea 
                  required
                  className="url-input" 
                  placeholder="Explain the concepts here..."
                  style={{ width: '100%', minHeight: '300px', resize: 'vertical', padding: '20px', lineHeight: '1.7', fontSize: '16px', fontFamily: 'var(--font-sans)', border: '1px solid var(--border)' }}
              ...
              <div style={{ marginTop: '20px', paddingTop: '32px', borderTop: '1px solid var(--border)', display: 'flex', justifyContent: 'flex-end', gap: '16px' }}>
                      ...
                      >
                        {imagePreview && (
                          <div style={{ 
                            ...
                            <img src={imagePreview} alt="Slide content" style={{ width: '100%', height: '100%', objectFit: 'contain', display: 'block' }} />
                          </div>
                        )}
                        <div style={{ flex: 1 }}>
